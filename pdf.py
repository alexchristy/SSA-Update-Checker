...
class Pdf:
    ...
    def __init__(self, link, type, terminal):
        ...
        # Verify and set PDF type
        if not self._valid_pdf_type(type):
    ...
    def _valid_pdf_type(self, type: str):
        ...
        if type in valid_types:
            ...
            logging.error(f'Unknown PDF type provided: {type}. Valid types are {valid_types}.')
            return False
    ...
    def to_dict(self):
        ...
        return {
            ...
            'shouldDiscard': self.should_discard
        }
    ...
    def from_dict(cls, data):
        ...
        pdf.path = data['cloud_path']
        pdf.type = data['type']
        pdf.terminal = data['terminal']
        pdf.modify_time = data['modifyTime']
        pdf.creation_time = data['creationTime']
        pdf.should_discard = data['shouldDiscard']
        return pdf

    def __str__(self):
        return f"Pdf(filename={self.filename}, link={self.link}, hash={self.hash})"